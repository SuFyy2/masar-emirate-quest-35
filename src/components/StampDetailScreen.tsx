...
const StampDetailScreen = () => {
  const { emirateId, stampId } = useParams();
  ...
  return (
    <div className="min-h-screen bg-masar-cream">
      {/* Header */}
      ...
      <div className="p-6">
        ...
        <div className="mb-6">
          <div className="aspect-video rounded-xl overflow-hidden bg-masar-teal/10 relative">
            ...
            />
            <div className="absolute bottom-0 left-0 bg-masar-teal px-3 py-1 rounded-tr-lg">
        ...
        {/* Stamp Description */}
        <div className="mb-6">
          <h2 className="text-lg font-bold text-masar-teal mb-2">About</h2>
          <p className="text-masar-teal/80">{stampData.description}</p>
        </div>
        
        {/* Memory */}
        <div className="mb-6">
          <div className="flex justify-between items-center mb-2">
            <h2 className="text-lg font-bold text-masar-teal">My Memory</h2>
            {!isEditing && (
              <Button 
                variant="ghost" 
                size="sm" 
                onClick={handleStartEditing}
                className="text-masar-teal"
              >
          ...
          {stampData.memory && (
            <div className="mb-4 aspect-video rounded-lg overflow-hidden bg-masar-teal/10">
              <img
                src={stampData.memory}
                alt="Memory"
                className="w-full h-full object-cover"
              />
            </div>
          ...
          {isEditing ? (
            ...
            <div className="bg-white p-4 rounded-lg shadow-sm">
              <p className="text-masar-teal/80">
        ...
        {!isEditing && (
          <Button 
            variant="outline"
            className="w-full border-masar-teal text-masar-teal mb-6"
          >
