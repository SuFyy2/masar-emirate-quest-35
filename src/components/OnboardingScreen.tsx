...
const OnboardingScreen = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-masar-cream">
      ...
      <div className="bg-masar-cream p-8">
        <div className="flex justify-between items-center mb-8">
          ...
          <Button 
            onClick={handleNext}
            className="bg-masar-teal hover:bg-masar-teal/90 text-white rounded-full px-6 py-4 h-auto"
          >
        ...
        {currentPage === onboardingContent.length - 1 && (
          <Button 
            ...
            className="text-masar-teal underline underline-offset-4 w-full"
          >
            Skip
          </Button>
        )}
