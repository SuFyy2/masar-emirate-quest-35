    ...
    <div className="min-h-screen bg-masar-cream pb-20">
      ...
      <div className="bg-masar-teal/10 mx-4 my-4 p-4 rounded-xl flex items-center">
        <div className="w-14 h-14 rounded-full flex items-center justify-center mr-3">
          <img 
            src="/lovable-uploads/984e2ec2-cb8a-4d95-afeb-0e2d2195bd08.png" 
            alt="Hamdoon Character"
      ...
      <div className="px-4 my-6">
        ...
        <div className="bg-white rounded-xl shadow-lg overflow-hidden">
          <div 
            className="relative h-44 flex items-center justify-center bg-masar-blue cursor-pointer"
          ...
          >
            ...
            <img 
              src="/lovable-uploads/a92a45f1-1537-447f-81fb-efca16896380.png" 
              alt="Masar Logo" 
              className="w-24 h-auto mb-2 z-10"
            />
          ...
          <div className="p-4 flex items-center justify-between">
            ...
            <Button 
              className="bg-masar-teal hover:bg-masar-teal/90 text-white ml-4 font-semibold"
              onClick={handlePassportClick}
            >
              View
            </Button>
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 p-4 flex justify-center">
        <Button 
          ...
          className="bg-masar-teal hover:bg-masar-teal/90 text-white px-8 py-6 rounded-full h-auto text-lg font-semibold"
        >
          Scan for New Stamp
        </Button>
      </div>
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 p-4">
        <div className="flex justify-around">
          <Button 
            variant="ghost" 
            className="flex flex-col items-center text-masar-blue"
            onClick={() => {}}
          >
